...
window.YAKO_STRINGS.he = {
  ...
  cheers: ["כל הכבוד!","אתם מצליחים ממש יפה!","וואו, אתם כל כך חכמים!","אתם מבריקים!","בדיוק נכון, כל הכבוד!","אני כל כך גאה בכם!","עבודה נהדרת!","אתם כוכבים אמיתיים!","כן! הצלחתם!","יופי, עבודה נהדרת!","אתם גאונים קטנים!","מושלם — תמשיכו כך!","הידד! כל הכבוד!","כיף כף! נכון מאוד!","אתם מדהימים!","פנטסטי, חברים שלי!"],
  ramp: ["נכון!","כל הכבוד!","עבודה מצוינת!","אתם מבריקים!","וואו, אתם כל כך חכמים!","וואו, אני כל כך גאה בכם!"],
  tries: ["אופס! זה בסדר, נסו שוב!","זה לא זה — אתם יכולים!","כמעט! עוד פעם אחת!","ממש קרוב! נסו שוב.","ניסיון יפה! נסו עוד פעם.","אל דאגה — אתם תצליחו!","הממ, לא זה. נסו שוב!","יפה מאוד! ננסה שוב."],
  wrongNamed: "זה לא {key}. זה בסדר — נסו שוב!",
